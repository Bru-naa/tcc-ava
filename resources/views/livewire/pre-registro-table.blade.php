<div class="flex flex-col mb-4">
  ...
  <p class="text-center 2xl lg:4xl mb-4 font-medium">Pré-cadastros</p>
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">john@professor.gov.br</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">(61) 90000-0000</td>
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">maria.silva@coordenador.gov.br</td>
